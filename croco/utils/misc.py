...
class MetricLogger(object):
    def __init__(self, delimiter="\t", args=None):
        ...
        if self.args is not None:
            self.print_logs_path = os.path.join(self.args.output_dir, 'print_logs.txt')
        else:
            self.print_logs_path = None
        ...
        for it,obj in enumerate(iterable):
            ...
            if i % print_freq == 0 or i == len_iterable - 1:
                ...
                if torch.cuda.is_available():
                    ...
                    if self.print_logs_path is not None and is_main_process():
                        with open(self.print_logs_path, 'a') as f:
